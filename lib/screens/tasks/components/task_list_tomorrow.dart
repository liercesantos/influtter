...
class TaskListTomorrow extends StatefulWidget {
  const TaskListTomorrow({super.key});

  @override
  State<TaskListTomorrow> createState() => _TaskListTomorrowState();
}

class _TaskListTomorrowState extends State<TaskListTomorrow> {
  ...
  Future<void> _onLoad() async {
    ...
    try {
      ...
      tasks = await _contract.all(user, true);
